...
docs/                             文档
  能力库设计思路.md
  初始化引导提示词.md              复制发给 AI 即可初始化能力库
  能力库使用说明.md                写入全局记忆或启动上下文的长期使用说明
tests/                            测试桩和参数文件
scripts/                          打包脚本
```
...
1. 解压 release 包
2. 将 `docs/初始化引导提示词.md` 中的 `<能力库根目录>` 替换为实际路径，然后复制全文发给你的 AI。AI 会完成初始化（了解机制、迁移现有 MCP/skill 入库、写入长期使用说明）。
...
详细用法见 `docs/能力库使用说明.md`、`docs/能力库设计思路.md` 和 `skills/intake-flow/SKILL.md`。
